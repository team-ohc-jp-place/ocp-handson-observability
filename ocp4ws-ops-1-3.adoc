...
WARNING: 以降の作業は全て"userX-jmx-monitor"Projectで行います。 +
...
WARNING: 新しくイメージをPullするため、ビルドには少し時間がかかります。 +
...
NOTE: 必要に応じてJavaアプリケーションにAnnotationを付与することも可能です。 +
